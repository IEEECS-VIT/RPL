...
exports.message = exports.wrap({from: 'rivierapremierleague@gmail.com'});
...
"<table background='http://res.cloudinary.com/rpl/general/img7.jpg' align='center' cellpadding='0' cellspacing='0' " +
...
exports.interest = exports.wrap({
    from: 'rivierapremierleague@gmail.com',
    subject: 'Riviera Premier League v' + version + '.0, Riviera ' + (version + 2015)
}).attach_alternative(
"<table background='http://res.cloudinary.com/rpl/general/img0.jpg' align='center' cellpadding='0' cellspacing='0' width='600'" +
                                                    ...
                                                    "<table class='twelve columns' style='border-spacing: 0; border-collapse: collapse;" +
                                                        ...
                                                        "<tr style='vertical-align: top; text-align: left; padding: 0;' " +
                                                            ...
                                                            "<td class='six sub-columns' style='word-break: break-word;" +
                                                                ...
                                                                " align='left' valign='top'>" +
                                                                "<img src='http://res.cloudinary.com/rpl/general/rplsmall.jpg'" +
                                                ...
                                                "<table class='twelve columns' style='border-spacing: 0; border-collapse: collapse;" +
                                                    ...
                                                    "<tr style='vertical-align: top; text-align: left; padding: 0;' align='left'>" +
                                                        "<td style='word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto;" +
                                                            ...
                                                            "<a href='http://rivierapremierleague.com/' style='color: #2ba6cb;" +
                                                            ...
                                                            "<table class='tiny-button twitter' style='border-spacing: 0;" +
                                                                ...
                                                                "<tr style='vertical-align: top; text-align: left; padding: 0;' align='left'>" +
                                                                    "<td style='word-break: break-word; -webkit-hyphens: auto;" +
                                                                        ...
                                                                        "<a href='https://twitter.com/RivieraRPL' " +
                                                                            "style='color: #ffffff; text-decoration: none;" +
                                                                            " font-weight: normal; font-family: Helvetica, Arial, sans-serif;" +
                                                                            " font-size: 12px;'>" +
                                                                            "Twitter" +
