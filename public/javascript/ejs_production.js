(function()
{
    ...
    EJS.Buffer.prototype = {
        push : function(cmd){this.line.push(cmd)},
        cr : function()
        {
...
EJS.Helpers.prototype.hidden_field_tag = function(A, C, B){return this.input_field_tag(A, C, "hidden", B)};
...
EJS.Helpers.prototype.password_field_tag = function(A, C, B){return this.input_field_tag(A, C, "password", B)};
...
EJS.Helpers.prototype.single_tag_for = function(A, B){return this.tag(A, B, "/>")};
EJS.Helpers.prototype.start_tag_for = function(A, B){return this.tag(A, B)};
...
EJS.Helpers.prototype.tag_end = function(A){return "</" + A + ">"};
...
EJS.Helpers.prototype.text_field_tag = function(A, C, B){return this.input_field_tag(A, C, "text", B)};
EJS.Helpers.prototype.url_for = function(A){return 'window.location="' + A + '";'};
