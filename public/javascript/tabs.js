...
function tab(a)
{
    ...
    document.getElementById('noact' + a).id = 'act' + a;
    document.getElementById('act' + a).className = "tab-title active";
    document.getElementById('panel' + a).className = "content active";
    x = a;
}