...
exports.forgotPassword = function (doc, token, host, callback)
{
    ...
    var onFetch = function (err, document)
    {
        ...
        else if (document.value)
        {
            ...
            "<table background='http://res.cloudinary.com/rpl/general/img1.jpg' align='center' cellpadding='0' " +
                ...
                "<tr>" +
                    "<td align='left' style='padding: 20px 20px 20px 20px; font-family: courier; font-size: large;" +
                        "color: #ffd195; font-weight: bold;'>Regards,<br>Team RPL<br>IEEE Computer Society<br>VIT Student chapter" +
                    "</td>" +
                "</tr>" +
            "</table>"
            );
